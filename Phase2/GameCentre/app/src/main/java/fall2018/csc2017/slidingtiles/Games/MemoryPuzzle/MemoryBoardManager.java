package fall2018.csc2017.slidingtiles.Games.MemoryPuzzle;
 ...
 */
public class MemoryBoardManager implements Serializable, Game {
    /**
     * The board being managed.
     */
    private final static String GAME_NAME = "MEMORY PUZZLE";
    /**
     ...
     */
    private static ScoreBoard gameScoreBoard = new ScoreBoard();
     ...
     */
    public MemoryBoardManager(MemoryGameBoard board) {
        this.board = board;
    }
     ...
     * Set a new board.
     */
    public void setBoard(MemoryGameBoard board) {
        this.board = board;
        board.update();
    }
