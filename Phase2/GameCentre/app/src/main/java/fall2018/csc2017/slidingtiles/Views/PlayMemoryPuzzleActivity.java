...
public class PlayMemoryPuzzleActivity extends AppCompatActivity implements Observer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        memoryBoardManager = (MemoryBoardManager) GameLauncher.getCurrentUser().getRecentManagerOfBoard(MemoryBoardManager.getGameName());
    ...
    private void addView() {
        ...
        gridView.setNumColumns(MemoryGameBoard.getNumCols());
        ...
        gridView.getViewTreeObserver().addOnGlobalLayoutListener(
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        columnWidth = displayWidth / MemoryGameBoard.getNumCols();
                        columnHeight = displayHeight / MemoryGameBoard.getNumRows();
    ...
    private void addSaveButtonListener() {
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!GameLauncher.getCurrentUser().getStackOfGameStates(MemoryBoardManager.getGameName()).isEmpty()
    ...
    private void switchToScoreBoard() {
        ...
        tmp.putExtra("scores", MemoryBoardManager.getGameScoreboard().toString());
        tmp.putExtra("game", MemoryBoardManager.getGameName());
        startActivity(tmp);
    }
