 ...
 */
public class SlidingTilesManager implements Serializable, Game {

    /***
     * The board being managed.
     */
    private final static String GAME_NAME = "SLIDING TILES";
     ...
     */
    public SlidingTilesManager(SlidingTilesBoard board) {
        this.board = board;
    }
     ...
     * Set a new board.
     */
    public void setBoard(SlidingTilesBoard board) {
        this.board = board;
        board.update();
    }
     ...
     * @return the tiles of the current board.
     */
    public ArrayList<Object> getTilesInArrayList() {
