...
public class PegSolitaireBoard extends Board {
     ...
     */
    public PegSolitaireBoard(List<PegSolitaireTile> tiles) {
     ...
     * @return all the tiles for the board
     */
    public PegSolitaireTile[][] getPegTiles() {
        return tiles;
    }
     ...
     * @return the tile at (row, col)
     */
    public PegSolitaireTile getPegTile(int row, int col) {
     ...
     */
    public List<Integer> moveGamepiece(int row1, int col1, int row2, int col2) {
     ...
     */
    public void undoMove(int row1, int col1, int row2, int col2) {
     ...
     */
    public void addOrRemoveHighlight(int row, int col) {
